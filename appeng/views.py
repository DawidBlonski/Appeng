...
def home(request):
        ...
        if request.user.is_authenticated:
                try:
                        user_answers = User_anwer_QuerySet.get_user_answer(current_user = request.user)
                        ...
                        args = { 'words':words,'win_score':win_score,'user_score':user_score,'user_answers':user_answers}
